...
INSERT into  PROJ(Name,Login_id,Password,Email,Phone_no,Gender,Age,Ticket_no) values('Mannie',1,"abc123",'mannie@gmail.com',9876543210,'F',19,201);
INSERT into  PROJ(Name,Login_id,Password,Email,Phone_no,Gender,Age,Ticket_no) values('Shreesha',2,"def456",'shreesha@gmail.com',0123456789,'M',19,202);
INSERT into  PROJ(Name,Login_id,Password,Email,Phone_no,Gender,Age,Ticket_no) values('Mahir',3,"hello987",'mahir@gmail.com',8763425608,'M',22,203);
INSERT into  PROJ(Name,Login_id,Password,Email,Phone_no,Gender,Age,Ticket_no) values('Virat',4,"hi987",'virat@gmail.com',9871239747,'M',29,204);
INSERT into  PROJ(Name,Login_id,Password,Email,Phone_no,Gender,Age,Ticket_no) values('Levin',5,"xyz123",'levin@gmail.com',8357290966,'M',47,205);
INSERT into  PROJ(Name,Login_id,Password,Email,Phone_no,Gender,Age,Ticket_no) values('Vasurva',6,"kkr143",'vasurva@gmail.com',9863638211,'M',36,206);
INSERT into  PROJ(Name,Login_id,Password,Email,Phone_no,Gender,Age,Ticket_no) values('Aaditya',7,"123pqr",'aaditya@gmail.com',9820963210,'M',65,207);
INSERT into  PROJ(Name,Login_id,Password,Email,Phone_no,Gender,Age,Ticket_no) values('Yash ',8,"a03a",'yash@gmail.com',9098763210,'M',19,208);
INSERT into  PROJ(Name,Login_id,Password,Email,Phone_no,Gender,Age,Ticket_no) values('Vaishnavi A',9,"qwert87",'vaishnavi@gmail.com',1234509876,'F',32,209);
INSERT into  PROJ(Name,Login_id,Password,Email,Phone_no,Gender,Age,Ticket_no) values('Lokendra ',10,"lpr123",'lokendra@gmail.com',9877073518,'M',52,210);
select*from  PROJ;
...
WHERE Name = 'Mannie';
UPDATE PROJ
SET Name = 'DakshayiniSJEC'
WHERE Name = 'Dakshayini';

create table Login (
Login_id numeric,
username  varchar(30) Not Null,
password varchar(15),
constraint fk_Login foreign key(Login_id) references  PROJ(Login_id)
);
INSERT into Login(Login_id, username,password) values (1,"me_mannie","abc123");
INSERT into Login(Login_id, username,password) values (2,"me_shreesha","def456");
INSERT into Login(Login_id, username,password) values (3,"me_mahir","hello987");
INSERT into Login(Login_id, username,password) values (4,"me_virat","hi987");
INSERT into Login(Login_id, username,password) values (5,"me_levin","xyz12");
INSERT into Login(Login_id, username,password) values (6,"me_vasurva","kkr143");
INSERT into Login(Login_id, username,password) values (7,"me_aaditya","123pqr");
...
Amount numeric,
constraint fk_Payment foreign key(Login_id) references  PROJ(Login_id)
);
...
Booking_Date date,
constraint fk_Booking foreign key(Login_id) references  PROJ(Login_id)
);
...
-- Query 1
-- Add a new user
INSERT into  PROJ(Name,Login_id,Password,Email,Phone_no,Gender,Age,Ticket_no) values('Nisha Patel',11,"ohwg",'nisha@gmail.com',9839210210,'F',23,'211');
select*from  PROJ;


-- Query 2
-- Update email 
Update  PROJ set Email="Mannie123@gmail.com" where Login_id=3;
select*from  PROJ;
...
SELECT *FROM  PROJ WHERE Name LIKE '%Ag%';
...
DELETE FROM  PROJ WHERE Login_id = 11;
select* from  PROJ;
...
FROM movie_Show 
INNER JOIN Movie 
ON movie_Show.Movie_id = Movie.Movie_id;
